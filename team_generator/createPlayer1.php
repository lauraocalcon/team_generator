        ...
        <div class="row main-row">
                ...
                <section>
                    ...
                    <ul class="small-image-list">
                        ...
                        <li>
                            <h4>Player Menu</h4>
                            <ul>
                                <li><a href="createPlayer.html">Create Player</a></li>
            ...
            <div class="8u skel-cell-important">
                ...
                <div id="form_container">
                    <form id="form_781162" class="appnitro"  action="insert.php" method="post">
                        ...
                        <ul>
                            ...
                            <li class="buttons">
                                ...
                                <input id="saveForm" class="button_text" type="submit" name="submit" value="Submit" onclick="return resetForm(this.form);"/>
                            </li>
                        </ul>
                    </form>
                </div>
